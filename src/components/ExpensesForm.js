...
class ExpensesForm extends Component {
  ...
  onSubmit() {
    ...
    const values = (Object.entries(currencies)); // obtem array de objetos contendo as infos de cada moeda;

    const objValues = values.reduce((acc, curr) => ({
      ...acc, [curr[0]]: curr[1] }), {});
    ...
    this.total(); // calcula o valor da despesas de acordo com a moeda informada.
  }
